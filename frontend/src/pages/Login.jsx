  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 min-h-screen">
        ...
        <section className="flex min-h-screen items-center px-8 pb-10 pt-32 sm:px-12 lg:w-[58%] lg:px-16 xl:px-20">
          ...
          <div className="max-w-2xl">
            ...
            <p className="mt-7 max-w-xl text-base leading-7 text-white/80 sm:text-lg sm:leading-8">
              Understand what you're eating, track your daily
              nutrition, and make better food choices without
              making food complicated.
            </p>
        ...
        {/* =====================================================
            WIDE + SHORT LOGIN CARD
        ====================================================== */}

        <section className="absolute right-[4%] top-1/2 w-[min(620px,43vw)] -translate-y-1/2">
            ...
            >
              ...
              <div>
                ...
                <div className="mb-1.5 flex items-center justify-between">
                  ...
                  <label
                    htmlFor="password"
                    className="text-xs font-semibold text-[#243029]"
                  >
                    Password
                  </label>
                  ...
                  <button
                    type="button"
                    className="text-[11px] font-semibold text-[#4F8F5B] hover:text-[#1F4D3A]"
                  >
                    Forgot password?
                  </button>
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  id="remember"
                  type="checkbox"
                  className="h-3.5 w-3.5 accent-[#1F4D3A]"
                />

                <label
                  htmlFor="remember"
                  className="text-[11px] text-[#6C786F]"
                >
                  Remember me
                </label>
